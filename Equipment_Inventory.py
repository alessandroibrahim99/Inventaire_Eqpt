...
Class_listt = st.sidebar.selectbox('SubClass Name', list(dfstate[dfstate.EquipClassName == Class_list].EquipSousClassName.unique()), index=0)
...
Class_list1 = st.sidebar.selectbox('SubClass Name', list(df1[df1.EquipClassName == State_list1].EquipSousClassName.unique()), index=0)#, index=0)#[:40000])
